...
|:----------:|:----------:|:----------:|:----------:|
| <img src="https://oscimg.oschina.net/oscnet/up-072a5880eaf5ea502dc265bc208902b8529.png" width="400" style="width:400px;" /> | 暂无 | 暂无 | 暂无 |
| 【小驿物联】| 待定 | 待定 | 待定 |
...
- 其他（部分开发中）：第三方登录，设备分享、设备告警、场景联动（进度50%）; 智能音箱、多租户、APP界面自定义（进度40%）; 时序数据库、分布式集群部署、Granfa监控（进度30%）; 视频流处理、桌面端模拟器/监控、安卓端模拟器/监控（进度20%）
