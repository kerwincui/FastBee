...
#### APP和管理端 &emsp;&emsp;测试账号：wumei &emsp;&emsp;密码：admin123
* APP下载：[进入下载界面>>>](https://gitee.com/kerwincui/wumei-smart/wikis/pages?sort_id=4203153&doc_id=1506495)
* 管理端入口：[进入登录界面>>>](http://iot.wumei.live/)
