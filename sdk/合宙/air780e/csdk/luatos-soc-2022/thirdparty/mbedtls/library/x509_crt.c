                               ...
                               const mbedtls_x509_crt_profile *profile )
{
    ...
    while( crl_list != NULL )
    {
         ...
         */
        //ECPLAT_PRINTF(UNILOG_SSL, x509_crt_verifycrl_1, P_INFO, "check the crl_list");
...
check_signature:
        ...
        /* optional time check */
        //ECPLAT_PRINTF(UNILOG_SSL, x509_crt_find_parent_in_1, P_INFO, "check the parent");
                ...
                mbedtls_x509_crt_restart_ctx *rs_ctx )
{
    ...
    while( 1 ) {
        ...
        //ECPLAT_PRINTF(UNILOG_SSL, x509_crt_verify_chain_1, P_INFO, "check the child");
...
find_parent:
        ...
        if( parent == NULL )
        {
            *flags |= MBEDTLS_X509_BADCERT_NOT_TRUSTED;
            //ECPLAT_PRINTF(UNILOG_SSL, x509_crt_verify_chain_2, P_INFO, "*flags=0x%x", *flags);
            return( 0 );
        }
                                  ...
                                  uint32_t *flags )
{
    ...
    if( crt->ext_types & MBEDTLS_X509_EXT_SUBJECT_ALT_NAME )
    {
        ...
        if( cur == NULL )
            ...
            *flags |= 0;    //EC change to not verify CN for custom will use non-standard certificates
    }
    else
    {
...
exit:
    ...
    if( *flags != 0 ){
        //ECPLAT_PRINTF(UNILOG_SSL, x509_crt_verify_restartable_ca_cb_1, P_INFO, "*flags=0x%x,verify cert failed", *flags);
