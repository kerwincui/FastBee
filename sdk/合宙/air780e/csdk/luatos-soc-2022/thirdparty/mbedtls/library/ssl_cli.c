...
static int ssl_write_client_hello( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_write_client_hello_1, P_INFO, 0, "=> write client hello");
    ...
    MBEDTLS_SSL_DEBUG_MSG( 3, ( "client hello, max version: [%d:%d]",
                   buf[4], buf[5] ) );
    //ECOMM_TRACE(UNILOG_SSL, ssl_write_client_hello_2, P_WARNING, 2, "client hello, max version: [%d:%d]",buf[4], buf[5]);
    ...
    *q++ = (unsigned char)( n << 1 );
    ...
    MBEDTLS_SSL_DEBUG_MSG( 2, ( "<= write client hello" ) );
    //ECOMM_TRACE(UNILOG_SSL, ssl_write_client_hello_3, P_WARNING, 0, "<= write client hello");
...
static int ssl_parse_server_hello( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_parse_server_hello_1, P_INFO, 0, "....=> ssl_parse_server_hello");
...
#if defined(MBEDTLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED) ||defined(MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED) ||defined(MBEDTLS_KEY_EXCHANGE_ECDHE_PSK_ENABLED) ||defined(MBEDTLS_KEY_EXCHANGE_ECDH_RSA_ENABLED) ||defined(MBEDTLS_KEY_EXCHANGE_ECDH_ECDSA_ENABLED)
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
#if defined(MBEDTLS_KEY_EXCHANGE_DHE_RSA_ENABLED) ||defined(MBEDTLS_KEY_EXCHANGE_ECDHE_RSA_ENABLED) ||defined(MBEDTLS_KEY_EXCHANGE_ECDHE_ECDSA_ENABLED)
...
static int ssl_parse_server_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_parse_server_key_exchange_1, P_INFO, 0, "....=> ssl_parse_server_key_exchange");
...
static int ssl_parse_certificate_request( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_parse_certificate_request, P_WARNING, 0, ".....=> ssl_parse_certificate_request");
...
static int ssl_parse_certificate_request( mbedtls_ssl_context *ssl )
{
    ...
    MBEDTLS_SSL_DEBUG_MSG( 2, ( "=> parse certificate request" ) );
    //ECOMM_TRACE(UNILOG_SSL, ssl_parse_certificate_request_1, P_WARNING, 0, ".....=> ssl_parse_certificate_request");
...
static int ssl_parse_server_hello_done( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_parse_server_hello_done_1, P_WARNING, 0, ".....=> ssl_parse_server_hello_done");
...
static int ssl_write_client_key_exchange( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_write_client_key_exchange_1, P_INFO, 0, ".....=> ssl_write_client_key_exchange");
...
static int ssl_write_certificate_verify( mbedtls_ssl_context *ssl )
{
    ...
    //ECOMM_TRACE(UNILOG_SSL, ssl_write_certificate_verify_1, P_INFO, 0, ".....=> ssl_write_certificate_verify");
...
//    ECPLAT_PRINTF(UNILOG_SSL, mbedtls_ssl_handshake_client_step_1, P_INFO, "client state: %d", ssl->state);
