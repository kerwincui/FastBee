...
#if !LWIP_TCPIP_CORE_LOCKING_INPUT && !ENABLE_PSIF
LWIP_MEMPOOL(TCPIP_MSG_INPKT,MEMP_NUM_TCPIP_MSG_INPKT, sizeof(struct tcpip_msg),      "TCPIP_MSG_INPKT")
#endif /* !LWIP_TCPIP_CORE_LOCKING_INPUT */

#if !LWIP_TCPIP_CORE_LOCKING_INPUT && !ENABLE_PSIF
LWIP_MEMPOOL(TCPIP_MSG_PS_INPKT,MEMP_NUM_TCPIP_MSG_PS_INPKT, sizeof(struct tcpip_msg),      "TCPIP_MSG_PS_INPKT")
#endif /* !LWIP_TCPIP_CORE_LOCKING_INPUT */
...
//if enable LWIP_TIMER_ON_DEMOND, will alloc this structure dynamic
#if LWIP_TIMERS && !LWIP_TIMERS_CUSTOM &&!LWIP_TIMER_ON_DEMOND
