...
INSERT INTO "sys_menu" ("menu_id", "menu_name", "parent_id", "order_num", "path", "component", "query", "is_frame", "is_cache", "menu_type", "visible", "status", "perms", "icon", "create_by", "create_time", "update_by", "update_time", "remark") VALUES ('2141', '三方登录', '1', '12', 'platform', 'iot/platform/index', NULL, '1', '1', 'C', '0', '0', 'iot:platform:list', 'cloud', 'admin', TO_DATE('2022-04-11 18:55:34', 'SYYYY-MM-DD HH24:MI:SS'), 'admin', TO_DATE('2023-08-31 11:10:47', 'SYYYY-MM-DD HH24:MI:SS'), '');
