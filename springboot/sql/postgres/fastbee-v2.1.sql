...
COMMENT ON COLUMN "public"."sip_device_channel"."city_code" IS '城市编码';
COMMENT ON COLUMN "public"."sip_device_channel"."civil_code" IS '行政区域';
...
COMMENT ON COLUMN "public"."sip_device_channel"."parent_id" IS '父级id';
COMMENT ON COLUMN "public"."sip_device_channel"."ip_address" IS '设备入网IP';
COMMENT ON COLUMN "public"."sip_device_channel"."port" IS '设备接入端口号';
COMMENT ON COLUMN "public"."sip_device_channel"."password" IS '密码';
COMMENT ON COLUMN "public"."sip_device_channel"."ptz_type" IS 'PTZ类型';
COMMENT ON COLUMN "public"."sip_device_channel"."ptz_type_text" IS 'PTZ类型描述字符串';
...
COMMENT ON COLUMN "public"."sip_device_channel"."stream_id" IS '流媒体ID';
COMMENT ON COLUMN "public"."sip_device_channel"."sub_count" IS '子设备数';
COMMENT ON COLUMN "public"."sip_device_channel"."parental" IS '是否有子设备（1-有, 0-没有）';
COMMENT ON COLUMN "public"."sip_device_channel"."has_audio" IS '是否含有音频（1-有, 0-没有）';
...
INSERT INTO "public"."sip_device_channel" VALUES (102, 1, 'admin', 135, '视频监控', 0, '', '11010100001320000001', '11010100001320000001', 'IPdome', '2024-01-09 23:35:00', '132', '132', '北京市/市辖区/东城区', '3402000000', 'Hikvision', 'IP Camera', 'Owner', '', 'Address', '34020000002000000001', '', 0, '', 0, '', 3, 0.000000, 0.000000, '', 0, 0, 0, '0', '', '2024-01-08 22:15:57', '', NULL, NULL);
COMMIT;
...
INSERT INTO "public"."sys_dict_data" ("dict_code", "dict_sort", "dict_label", "dict_value", "dict_type", "css_class", "list_class", "is_default", "status", "create_by", "create_time", "update_by", "update_time", "remark") VALUES (248, 0, '16位 无符号', 'ushort', 'iot_modbus_data_type', NULL, 'default', 'N', '0', 'admin', '2023-09-04 14:11:54', '', NULL, NULL);
...
INSERT INTO "public"."sys_dict_data" ("dict_code", "dict_sort", "dict_label", "dict_value", "dict_type", "css_class", "list_class", "is_default", "status", "create_by", "create_time", "update_by", "update_time", "remark") VALUES (251, 3, '32位 有符号(CDAB)', 'long-CDAB', 'iot_modbus_data_type', NULL, 'default', 'N', '0', 'admin', '2023-09-04 14:13:21', '', NULL, NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."sys_dict_data_translate" ("id", "zh_cn", "en_us") VALUES (1, '男', 'man');
INSERT INTO "public"."sys_dict_data_translate" ("id", "zh_cn", "en_us") VALUES (2, '女', 'woman');
...
INSERT INTO "public"."sys_dict_data_translate" ("id", "zh_cn", "en_us") VALUES (12, '是', 'be');
INSERT INTO "public"."sys_dict_data_translate" ("id", "zh_cn", "en_us") VALUES (13, '否', 'not');
...
INSERT INTO "public"."sys_dict_data_translate" ("id", "zh_cn", "en_us") VALUES (108, '是', 'be');
INSERT INTO "public"."sys_dict_data_translate" ("id", "zh_cn", "en_us") VALUES (109, '否', 'not');
...
INSERT INTO "public"."sys_dict_type" ("dict_id", "dict_name", "dict_type", "status", "create_by", "create_time", "update_by", "update_time", "remark") VALUES (149, '规则脚本事件', 'rule_script_event', '0', 'admin', '2023-12-19 11:33:48', '', NULL, '1=设备上报，2=平台下发，3=设备上线，4=设备离线');
INSERT INTO "public"."sys_dict_type" ("dict_id", "dict_name", "dict_type", "status", "create_by", "create_time", "update_by", "update_time", "remark") VALUES (150, '规则脚本用途', 'rule_script_purpose', '0', 'admin', '2023-12-19 11:38:18', '', NULL, '1=数据流，2=触发器，3=执行动作');
INSERT INTO "public"."sys_dict_type" ("dict_id", "dict_name", "dict_type", "status", "create_by", "create_time", "update_by", "update_time", "remark") VALUES (151, '规则脚本动作', 'rule_script_action', '0', 'admin', '2023-12-19 11:39:58', '', NULL, '1=消息重发，2=消息通知，3=Http推送，4=Mqtt桥接，5=数据库存储');
COMMIT;
